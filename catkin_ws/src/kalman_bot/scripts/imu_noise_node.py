...
def add_noise(imu_data):
    ...
    norm = np.sqrt(imu_data.orientation.x**2 + imu_data.orientation.y**2 + 
                   imu_data.orientation.z**2 + imu_data.orientation.w**2)
    imu_data.orientation.x /= norm
    imu_data.orientation.y /= norm
    imu_data.orientation.z /= norm
    imu_data.orientation.w /= norm
